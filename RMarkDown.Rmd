...
Then, we execute the above method "nIterations" times for each number of subjects specified above, both for precision and accuracy, using the replicate() function from the R core package.
