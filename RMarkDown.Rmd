...
```{r Staircase13, include=FALSE}
anova(mod1,mod2)$`Pr(>Chisq)`[2]
summary(mod1)
```

If the test model is significantly (p < 0.5) better than the comparison model, the test variable has a relevant impact on the responses.
