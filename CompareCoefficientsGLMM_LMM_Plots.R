...
Dataframe2 = read.csv("Data/GLMMvsLMMCoefficients.csv")
...
ggsave("Figures/FigureValuesFromGLMMs_0.05_0.125_LMMGLMM.jpeg", w = 12, h = 7.2)
#####
...
ggsave(paste0("Figures/FigureSEsFromGLMMs_0.05_0.125_LMMGLMM.jpeg"), w = 12, h = 7.2)
...
ggsave(paste0("Figures/FigurePValuesFromGLMMs_0.05_0.125_LMMGLMM.jpeg"), w = 12, h = 7.2)
#####

#####
#AICs
ggplot(Dataframe2 %>% filter(PSE_Difference == 0.05 & JND_Difference == 0.125 & Model != "M_LMM"),aes(Model,AIC_Norm)) +
  geom_boxplot() + 
  xlab("") +
  ylab("AIC - AIC(Model25)") +
  geom_hline(aes(yintercept = 0), linetype = 2, size = 1) +
  ggtitle("AIC (PSE Difference = 0.05/JND Difference = 0.125)")
ggsave(paste0("Figures/Figure AICs_0.05_0.125_Models_LMMGLMM.jpeg"), w = 12, h = 3.6)
#####
...
ggsave(paste0("Figures/FigureValuesFromGLMMs_-0.05_-0.125_LMMGLMM.jpeg"), w = 12, h = 7.2)
#####
...
ggsave(paste0("Figures/FigureSEsFromGLMMs_-0.05_-0.125_LMMGLMM.jpeg"), w = 12, h = 7.2)
...
ggsave(paste0("Figures/FigurePValuesFromGLMMs_-0.05_-0.125_LMMGLMM.jpeg"), w = 12, h = 7.2)
#####
...
ggplot(Dataframe2 %>% filter(PSE_Difference == -0.05 & JND_Difference == -0.125 & Model != "M_LMM"),aes(Model,AIC_Norm)) +
  ...
  geom_hline(aes(yintercept = 0), linetype = 2, size = 1) +
  ggtitle("AIC (PSE Difference = -0.05/JND Difference = -0.125)")
ggsave(paste0("Figures/Figure AICs_-0.05_-0.125_Models_LMMGLMM.jpeg"), w = 12, h = 3.6)
#####
...
ggsave(paste0("Figures/FigureValuesFromGLMMs_0_0.125_LMMGLMM.jpeg"), w = 12, h = 7.2)
#####
...
ggsave(paste0("Figures/FigureSEsFromGLMMs_0_0.125_LMMGLMM.jpeg"), w = 12, h = 7.2)
...
ggsave(paste0("Figures/FigurePValuesFromGLMMs_0_0.125_LMMGLMM.jpeg"), w = 12, h = 7.2)
#####

#####
#AICs
ggplot(Dataframe2 %>% filter(PSE_Difference == 0 & JND_Difference == 0.125 & Model != "M_LMM"),aes(Model,AIC_Norm)) +
  geom_boxplot() + 
  xlab("") +
  ylab("AIC - AIC(Model25)") +
  geom_hline(aes(yintercept = 0), linetype = 2, size = 1) +
  ggtitle("AIC (PSE Difference = 0/JND Difference = 0.125)")
ggsave(paste0("Figures/Figure AICs_0-0.125_Models_LMMGLMM.jpeg"), w = 12, h = 3.6)
#####
...
ggsave(paste0("Figures/FigureValuesFromGLMMs_-0.05_0.125_LMMGLMM.jpeg"), w = 12, h = 7.2)
#####
...
ggsave(paste0("Figures/FigureSEsFromGLMMs_-0.05_0.125_LMMGLMM.jpeg"), w = 12, h = 7.2)
...
ggsave(paste0("Figures/FigurePValuesFromGLMMs_-0.05_0.125_LMMGLMM.jpeg"), w = 12, h = 7.2)
#####
...
ggplot(Dataframe2 %>% filter(PSE_Difference == -0.05 & JND_Difference == 0.125 & Model != "M_LMM"),aes(Model,AIC_Norm)) +
  ...
  geom_hline(aes(yintercept = 0), linetype = 2, size = 1) +
  ggtitle("AIC (PSE Difference = -0.05/JND Difference = 0.125)")
ggsave(paste0("Figures/Figure AICs_-0.05_0.125_Models_LMMGLMM.jpeg"), w = 12, h = 3.6)
#####
...
ggsave(paste0("Figures/FigureValuesFromGLMMs_0.05_0_LMMGLMM.jpeg"), w = 12, h = 7.2)
#####
...
ggsave(paste0("Figures/FigureSEsFromGLMMs_0.05_0_LMMGLMM.jpeg"), w = 12, h = 7.2)
...
ggsave(paste0("Figures/FigurePValuesFromGLMMs_0.05_0_LMMGLMM.jpeg"), w = 12, h = 7.2)
#####

#####
#AICs
ggplot(Dataframe2 %>% filter(PSE_Difference == 0.05 & JND_Difference == 0 & Model != "M_LMM"),aes(Model,AIC_Norm)) +
  geom_boxplot() + 
  xlab("") +
  ylab("AIC - AIC(Model25)") +
  geom_hline(aes(yintercept = 0), linetype = 2, size = 1) +
  ggtitle("AIC (PSE Difference = 0.05/JND Difference = 0)")
ggsave(paste0("Figures/Figure AICs_0.05_0_Models_LMMGLMM.jpeg"), w = 12, h = 3.6)
#####
...
ggsave(paste0("Figures/FigureValuesFromGLMMs_0.05_-0.125_LMMGLMM.jpeg"), w = 12, h = 7.2)
#####
...
ggsave(paste0("Figures/FigureSEsFromGLMMs_0.05_-0.125_LMMGLMM.jpeg"), w = 12, h = 7.2)
...
ggsave(paste0("Figures/FigurePValuesFromGLMMs_0.05_-0.125_LMMGLMM.jpeg"), w = 12, h = 7.2)
#####
...
ggplot(Dataframe2 %>% filter(PSE_Difference == 0.05 & JND_Difference == -0.125 & Model != "M_LMM"),aes(Model,AIC_Norm)) +
  ...
  geom_hline(aes(yintercept = 0), linetype = 2, size = 1) +
  ggtitle("AIC (PSE Difference = 0.05/JND Difference = -0.125)")
ggsave(paste0("Figures/Figure AICs_0.05_-0.125_Models_LMMGLMM.jpeg"), w = 12, h = 3.6)
#####
...
ggsave(paste0("Figures/Power All_LMMGLMM.jpeg"), w = 12, h = 3.6)