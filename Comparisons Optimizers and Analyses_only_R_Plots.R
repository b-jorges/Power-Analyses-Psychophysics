...
ggsave("Figures/Different Durations only R.jpg",w=9,h=6)
...
ggsave("Figures/False Positives only R.jpg",w=12,h=6)
...
ggplot(Dataframe_pvalues %>%
  ...
  scale_x_continuous(breaks = c(10,15,20))
ggsave("Figures/AIC differences only R.jpg",w=12,h=6)
